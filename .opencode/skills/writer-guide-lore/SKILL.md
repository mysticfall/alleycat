...
4. source material approved for canon use,
5. intended reader/consumer of the entry, especially whether it is prompt-available.
...
7. Preserve valid frontmatter, aliases, tags, wiki links, typed links, and existing authored wording unless the request
   explicitly scopes a change.
8. Keep prose concise and perspective-safe: prefer direct statements the observer can use over meta-commentary about
