...
/// <summary>
/// Transition from the standing continuum to kneeling, gated by crouch depth and an armed
/// forward-retreat trigger.
/// </summary>
/// <remarks>
/// <para>
...
/// <see cref="KneelingToStandingPoseTransition"/>. The opposite-direction transition is also
...
{
    /// <summary>
    /// Transitional AnimationTree state that plays the kneeling entry clip.
    /// </summary>
    [Export]
    public StringName EntryStateName
    {
        get;
        set;
    } = new("KneelingEnter");
    ...
    /// <summary>
    /// Forward offset ratio past <see cref="FullCrouchForwardOffsetRatio"/> that arms the kneel trigger.
    /// </summary>
    [Export]
    ...
    /// <inheritdoc />
    protected override StringName TransitionAnimationStateName => EntryStateName;
}
