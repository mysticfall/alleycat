...
public sealed class PoseStateMachineIntegrationTests
{
    ...
    private const string FootTargetSyncControllerPath = "Subject/Female/Female/GeneralSkeleton/FootTargetSyncController";
    ...
    private const string LeftLegTwoBoneIKControllerPath = "Subject/Female/Female/GeneralSkeleton/LeftLegTwoBoneIKController";
    private const string RightLegTwoBoneIKControllerPath = "Subject/Female/Female/GeneralSkeleton/RightLegTwoBoneIKController";
    private const string CopyLeftFootRotationPath = "Subject/Female/Female/GeneralSkeleton/CopyLeftFootRotation";
    private const string CopyRightFootRotationPath = "Subject/Female/Female/GeneralSkeleton/CopyRightFootRotation";
