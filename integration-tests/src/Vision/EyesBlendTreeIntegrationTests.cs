...
/// <summary>
/// Integration coverage for VISION-001 Eyes reference tree resources and controller behaviour.
/// </summary>
public sealed class EyesBlendTreeIntegrationTests
{
    ...
    private const string EyesPhotoboothScenePath = "res://tests/vision/eyes_visual_test.tscn";
