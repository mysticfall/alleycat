...
Historical BODY identifiers are retained only for traceability; they do not define a current taxonomy.

- Character Impact Event Sampling
- Partial Hit Reaction Overlay
- Stagger Response
- Soft Character Grab Constraints
- Ragdoll/Physical Constraint Bridge
