...
17. This slice shall not introduce new Rigging → IK dependencies: IK may consume
...
11. Technical Requirement 17 validated: diff/import analysis confirms this slice adds no new
      Rigging → IK dependency, and `DynamicPhysicalRig`/physical collision proxy generation remain
     IK-independent.
